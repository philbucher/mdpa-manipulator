...
modelpart_1 = model_part_manipulator_utility.ModelPartManipulator("WINSENT_Blade_Shell")
...
modelpart_2 = model_part_manipulator_utility.ModelPartManipulator("WINSENT_Blade_Shell.mdpa")

modelpart_2.TranslateModelPart([0,0,0.65])

modelpart_2.RotateModelPart([1,0,0], 120)

modelpart_3 = model_part_manipulator_utility.ModelPartManipulator("WINSENT_Blade_Shell.mdpa")
